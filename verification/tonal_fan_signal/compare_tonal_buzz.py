...
# Paths
folder = "verification/tonal_fan_signal"
matlab_data = loadmat(os.path.join(folder, "tonal_fan_signal_matlab.mat"))

signal_matlab = matlab_data["TonalSignal_FanHarmonics"].squeeze()

python_data = np.load("verification/tonal_fan_signal/tonal_fan_signal_python.npz")
