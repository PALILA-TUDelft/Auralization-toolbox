...
# Load data
folder = "verification/airframe"
matlab_data = loadmat(os.path.join(folder, "auralizedAirframeSignal_MATLAB.mat"))
signal_matlab = matlab_data["auralizedAirframeSignal"].squeeze()

python_data = np.load(os.path.join(folder, "airframe_signal_python.npz"))
